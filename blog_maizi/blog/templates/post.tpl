...
<div id="section" class="box">
    ...
    <form action="http://{{$smarty.const.global_localhost}}/blog_maizi/blog/?action=SubmitPostBlog" method="post" class="form" onsubmit="return checkPostBlog();" >
        <ul>
            <li>
                ...
                分类:<select name="blog_type">
                    {{foreach from=$data.blog_type item=item key=key}}
